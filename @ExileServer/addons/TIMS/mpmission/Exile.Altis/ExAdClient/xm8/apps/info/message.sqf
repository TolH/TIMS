...
<t align='center' color='#FFFF00'>Admins : BADASS,  DEEPDEMON211, 0908</t><br />
<t align='center' color='#FFFFFF'>No stealing</t><br />
...
<t align='center' color='#FFFFFF'NO TROLLING OTHER PLAYERS. STALKING AND HARASSMENT WILL NOT BE TOLERATED</t><br />
<t align='center' color='#FFFF00'>GENERAL RULES</t><br />
______________________________________________________________________________<br />

<br /><t color='#E48A36'>The AI</t><br />
<br /><t color='#FFFFFF'> There are roaming AI on.</t><br />
<br /><t color='#FFFF00'> AI CHOPPERS AND DRONES ARE IN THE AIR</t><br />
...
<t color='#FFFF00'>No stealing inside safezone. This only applies if another player(s) is nearby their vehicle/loot crates. ASK in chat if unsure. </t><br />
<t color='#FFFFFF'>Unlocked vehicles of crates dropped in trader with no other player nearby are free to take.  Nearby=inside safezone!</t><br />
<t color='#FFFF00'>No Safezone camping</t><br />
______________________________________________________________________________<br />

<t color='#E48A36'>BUILDING RULES</t><br />
<t color='#FFFF00'>AI can and WILL attack your base at level 3 or higher.</t><br />
<t color='#FFFFFF'>Approx. 1000meter from safezone's.</t><br />
<t color='#FFFF00'>No building on or over roads.</t><br />
<t color='#FFFFFF'>No blocking of loot areas with base building</t><br />
<t color='#FFFF00'>Remember to put vehicles in the virtual garage.</t><br />
<t color='#FFFFFF'>No building on Military Bases, Towns, or Airfields.</t><br />
<t color='#FFFF00'>Build your base to rapel an AI attack! </t><br />
<t color='#FFFFFF'>NO BUILDING 1000M FROM TRADER/ AREAS 600M FROM HIGH LOOT AREAS</t><br />
<t color='#FFFF00'>300M FROM GAS STATIONS /20M FROM ROADS 
                   *MILITARY, FACTORY, INDUSTRIAL, HIGH LOOT OFFICE BUILDINGS ARE OFF LIMITS*</t><br />

______________________________________________________________________________<br />

 <t color='#FFFFFF'>IF U HAVE ANY QUESTIONS ON THESE RULE PLZ ASK A ADMIN THANKS. 
                    EVERY ONE IS HERE TO HAVE FUN AND PLAY TOGETHER
<t color='#FFFF00'>THIS IS A PVE SERVER ANY QUESTION PLEASE ASK ADMIN					
