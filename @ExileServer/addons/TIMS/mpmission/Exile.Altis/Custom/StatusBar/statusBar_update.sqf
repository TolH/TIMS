...
//WALLET
if ((_wallet > 999) && (_wallet < 999999)) then
{
	_wallet = format ["%1k", floor (_wallet / 1000)];
} 
else
{
	_wallet = format ["%1M", parseNumber ((_wallet / 1000000) toFixed 2)];
};
//LOCKER
if ((_locker > 999) && (_locker < 999999)) then
{
	_locker = format ["%1k", floor (_locker / 1000)];
} 
else
{
	_locker = format ["%1M", parseNumber ((_locker / 1000000) toFixed 2)];
};
//RESPECT
...
_Restart_timeR = serverTime;
_hours = (3 - 1) - floor (_Restart_timeR / 3600);
_minutes = 59 - floor ((_Restart_timeR % 3600) / 60);
...
format[
"
<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\players.paa' color='%10'/> %2 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\wallet.paa' color='%10'/> %4 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\locker.paa' color='%10'/> %17 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\respect.paa' color='%10'/> %9 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%11'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\health.paa' color='%11'/> %3%1 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%12'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\hunger.paa' color='%12'/> %5%1 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%13'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\thirst.paa' color='%13'/> %6%1 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\compass.paa' color='%10'/> %14 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\restart.paa' color='%10'/> %15:%16 </t>

<t shadow='1' shadowColor='#000000' size='0.9' color='%10'><img size='1.0'  shadowColor='#000000' image='Custom\StatusBar\Icons\fps.paa' color='%10'/> %7</t>",
