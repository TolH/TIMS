...
//*Syntax: nul = [this] execVM "TIMS\LV\patrol-vD.sqf";
//     or: nul = [this,center position,radius,handle doors] execVM "TIMS\LV\patrol-vD.sqf";
...
if(isNil("LV_CloseDoors"))then{LV_CloseDoors = compile preprocessFile "TIMS\LV\LV_functions\LV_fnc_closeDoors.sqf";};
