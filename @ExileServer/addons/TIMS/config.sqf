...
//==================================// 
	/*CRATES & LOOTS CONFIG*/
		...
		CRATE_MASS					= 50;							// CHANGE THE MASS OF THE CRATE. SET A HIGH AMOUNT AND VEHICLES WILL MOVE SLOWER.
		LOOT_TRACKER 				= 1;							// ENABLE OR DISABLE MOVING CRATE MARKER ON THE MAP. (Default 1=Enabled).
