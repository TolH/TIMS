...
_thermals = format ["( %1 ) %2 SCANNED LOCK OF %3 @ %4 - PIN IS %5 (if pin is 'any' means lock was cold)",_player,getPlayerUID _player,_object,mapGridPosition _object,_pinCode];
["THERMALSCANNERLOG",_thermals] call FNC_A3_CUSTOMLOG;