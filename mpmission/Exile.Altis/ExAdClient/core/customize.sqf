...
ExAd_Debug = false; 						//BOOLEAN - If you want the ExAd code to generate debug logs 
Exad_Logging = false;					//BOOLEAN - If you want the ExAd code to generate extra logs. - Requires InfiStar installed 
