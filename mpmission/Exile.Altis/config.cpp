...
class CfgExileCustomCode 
{
	...
	ExileClient_construction_beginExistingObject 			= "Exile_Call\Vector\ExileClient_construction_beginExistingObject.sqf";
	ExileClient_construction_beginNewObject 				= "Exile_Call\Vector\ExileClient_construction_beginNewObject.sqf";
	ExileClient_construction_thread 						= "Exile_Call\Vector\ExileClient_construction_thread.sqf";
	ExileClient_gui_constructionMode_update 				= "Exile_Call\Vector\ExileClient_gui_constructionMode_update.sqf";
	ExileClient_util_world_canBuildHere 					= "Exile_Call\Vector\ExileClient_util_world_canBuildHere.sqf";
	//SHARED FUNCTION  
		//VECTOR+FISHING
	...
	*/
	...
	class Flag
	{
		...
		class Actions
		{
			...
			class PayProtectionReminder : ExileAbstractAction
			{
				title = "Taxes Due Date Reminder";
				condition = "true";
				action = "execVM 'Custom\DueDate.sqf';";
			};
			class PayProtection : ExileAbstractAction
			{
				title = "Pay Territory Taxes";
				condition = "true";
			...
			class Manage : ExileAbstractAction
			{
				...
				condition = "true";
				action = "_this call ExileClient_gui_virtualGarageDialog_show";
			};
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{45000,					75,			150					}, // Level 5
		{70000,					90,			180					}, // Level 6
	...
	minimumDistanceToOtherTerritories = 425; 
...
class CfgXM8 
{
	extraApps[] = {"ExAd_JX","ExAd_Info","ExAd_CHVD","BRAmaRecipes","BaseMarker","ExAd_Quad","ExAd_Unit","scarCode","ExAd_VG","CAR_RACING"/*,"UAV_SPAWN","GPS_ADV"*/};
	...
	*/
	...
	class scarCode
	{
		...
		controlID = 66000;			
		logo = "scarCODE\ServerInfoMenu\img\Icon.paa";
    ...
    class ExAd_CHVD
    {
        ...
        logo = "scarCODE\ServerInfoMenu\img\Icon_CHVD.paa";
    ...
    class ExAd_JX
    {
        title = "Unit Scanner";
        controlID = 85100;                    
        logo = "scarCODE\ServerInfoMenu\img\logo.paa";
	...
	class BRAmaRecipes
    {
        controlID = 107000;
        title = "Recipies";
        logo = "scarCODE\ServerInfoMenu\img\BRAma.paa";
...
*/
    ...
    {
        title = "Racing Test";
        logo = "Custom\TIMS\misc\RaceCar.paa";
        onLoad = "ExAdClient\XM8\Apps\Info\onLoad.sqf";
        onOpen = "ExAdClient\XM8\Apps\Info\onOpen.sqf";
        onClose = "ExAdClient\XM8\Apps\Info\onClose.sqf";
    };
...
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\img\Icon_CHVD.paa";
...
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\img\Icon_SI.paa";
    text = "Server Rules";
...
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\img\logo.paa";
    text = "Unit Scanner";
...
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\img\BRAma.paa";
    text = "BRAmaRecipes";
...
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\img\Icon.paa";
    text = "Server Info";
    onButtonClick = "ExileClientXM8CurrentSlide = 'apps';closeDialog 0;[] execVM 'ExAdClient\xm8\apps\ServerInfoMenu\onOpen.sqf'";
    resource = "";
};

class XM8_App12_Button: RscExileXM8AppButton1x1
{
    textureNoShortcut = "scarCODE\ServerInfoMenu\img\Quad.paa";
...
{
    textureNoShortcut = "Custom\TIMS\misc\RaceCar.paa";
    text = "Racing Test";
    onButtonClick = "ExileClientXM8CurrentSlide = 'apps'; closeDialog 0; createDialog 'TIMS_MISSION_1_RACING'; ";
    resource = "";
};
