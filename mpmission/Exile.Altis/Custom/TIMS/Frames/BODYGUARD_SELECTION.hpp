...
//============================================////============================================//
	class TIMS_BODYGUARD_SELECTION
	{
		...
		class controls
		{
			...
			h = "(29.9999999999995 / 1080) * SafeZoneH";
				text = "											Sniper";
				action = " setMousePosition [0.5, 0.5]; if (GUARD_AImax < 3) then {GUARD_AImax = GUARD_AImax + 1; private _unit = group player createUnit [""I_Soldier_VR_F"", getPos player, [], 0, ""FORM""]; _unit setUnitLoadout [getUnitLoadout ""B_ghillie_ard_F"", true]; systemChat ""Sniper BodyGuard Joined Your Party!""; _unit setskill 0.6; _unit setCombatMode ""RED""; _unit allowFleeing 0; _unit addMPEventHandler [""MPKilled"",{ GUARD_AImax = GUARD_AImax - 1; deleteVehicle (_this select 0); }]; [_unit] execVM ""Custom\TIMS\Bodyguard\BodyGuard_Delete.sqf"";}; if (GUARD_AImax == 1) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 1/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 2) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 2/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 3) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 3/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax >= 3) then {[""ErrorTitleAndText"",[""You can only have 3 Bodyguards at a time...""]] call ExileClient_gui_toaster_addTemplateToast;}; ";
			};
			...
			h = "(29.9999999999994 / 1080) * SafeZoneH";
				text = "											Medic";
				action = " setMousePosition [0.5, 0.5]; if (GUARD_AImax < 3) then {GUARD_AImax = GUARD_AImax + 1; private _unit = group player createUnit [""I_Soldier_VR_F"", getPos player, [], 0, ""FORM""]; _unit setUnitLoadout [getUnitLoadout ""O_V_Soldier_Medic_ghex_F"", true]; systemChat ""Medic BodyGuard Joined Your Party!""; _unit setskill 0.6; _unit setCombatMode ""RED""; _unit allowFleeing 0; _unit addMPEventHandler [""MPKilled"",{ GUARD_AImax = GUARD_AImax - 1; deleteVehicle (_this select 0); }]; [_unit] execVM ""Custom\TIMS\Bodyguard\BodyGuard_Delete.sqf"";}; if (GUARD_AImax == 1) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 1/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 2) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 2/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 3) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 3/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax >= 3) then {[""ErrorTitleAndText"",[""You can only have 3 Bodyguards at a time...""]] call ExileClient_gui_toaster_addTemplateToast;}; ";
			};
			...
			h = "(29.9999999999995 / 1080) * SafeZoneH";
				text = "														LMG";
				action = " setMousePosition [0.5, 0.5]; if (GUARD_AImax < 3) then {GUARD_AImax = GUARD_AImax + 1; private _unit = group player createUnit [""I_Soldier_VR_F"", getPos player, [], 0, ""FORM""]; _unit setUnitLoadout [getUnitLoadout ""B_Patrol_Soldier_MG_F"", true]; systemChat ""LMG BodyGuard Joined Your Party!""; _unit setskill 0.6; _unit setCombatMode ""RED""; _unit allowFleeing 0; _unit addMPEventHandler [""MPKilled"",{ GUARD_AImax = GUARD_AImax - 1; deleteVehicle (_this select 0); }]; [_unit] execVM ""Custom\TIMS\Bodyguard\BodyGuard_Delete.sqf"";}; if (GUARD_AImax == 1) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 1/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 2) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 2/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 3) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 3/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax >= 3) then {[""ErrorTitleAndText"",[""You can only have 3 Bodyguards at a time...""]] call ExileClient_gui_toaster_addTemplateToast;}; ";
			};
			...
			h = "(29.9999999999995 / 1080) * SafeZoneH";
				text = "									  Clone";
				action = " setMousePosition [0.5, 0.5]; if (GUARD_AImax < 3) then {GUARD_AImax = GUARD_AImax + 1; private _unit = group player createUnit [""I_Soldier_VR_F"", getPos player, [], 0, ""FORM""]; _unit setUnitLoadout [getUnitLoadout player, true]; systemChat ""Clone BodyGuard Joined Your Party!""; _unit setskill 0.6; _unit setCombatMode ""RED""; _unit allowFleeing 0; _unit addMPEventHandler [""MPKilled"",{ GUARD_AImax = GUARD_AImax - 1; deleteVehicle (_this select 0); }]; [_unit] execVM ""Custom\TIMS\Bodyguard\BodyGuard_Delete.sqf"";}; if (GUARD_AImax == 1) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 1/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 2) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 2/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax == 3) then {[""SuccessTitleAndText"",[""Bodyguard Deployed 3/3""]] call ExileClient_gui_toaster_addTemplateToast;}; if (GUARD_AImax >= 3) then {[""ErrorTitleAndText"",[""You can only have 3 Bodyguards at a time...""]] call ExileClient_gui_toaster_addTemplateToast;}; ";
			};
