...
//============================================////============================================//
	class INVASION_MISSION_NOTIFICATION
	{
		idd = 88667;
		duration = 15;
		fadeIn = 1;
		...
		class controls
		{
			...
			class MyRscPicture
			{
				...
				sizeEx = 0;
				lineSpacing = 0;
				text = "Custom\TIMS\video\invasion.ogv";
				autoplay = 1;
				loops = 1;
				fixedWidth = 0;
				shadow = 1;
...
//============================================////============================================//
	class RANDOM_PATROL_C130J_NOTIFICATION
	{
		idd = 88668;
		duration = 15;
		fadeIn = 1;
		...
		class controls
		{
			...
			class MyRscPicture
			{
				...
				sizeEx = 0;
				lineSpacing = 0;
				text = "Custom\TIMS\Images\c130j.jpg";
				//autoplay = 1;
				//loops = 5;
				fixedWidth = 0;
				shadow = 1;
...
//============================================////============================================//
	class VR_HUNT_NOTIFICATION
	{
		...
		class controls
		{
			//MAIN IMAGE BACKGROUND COLOR FRAME			/*BOTTOM RIGHT*/
			class MyRscStructuredText
			{
				idc = -1; 
				type = 13;
			...
			class MyRscPicture
			{
				...
				sizeEx = 0;
				lineSpacing = 0;
				text = "Custom\TIMS\Images\vr.jpg";
				//autoplay = 1;
				//loops = 5;
				fixedWidth = 0;
				shadow = 1;
